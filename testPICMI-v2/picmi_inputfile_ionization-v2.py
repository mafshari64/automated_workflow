...
# Set the customTemplates path relative to the script's location
custom_template_dir = os.path.join(script_dir, 'customTemplates')

# Define the output directory path relative to the script's directory
OUTPUT_DIRECTORY_PATH = os.path.join(script_dir, "lwfa_ionization_v2")
...
sim = picmi.Simulation(
    ...
    picongpu_template_dir=custom_template_dir
    ) 
